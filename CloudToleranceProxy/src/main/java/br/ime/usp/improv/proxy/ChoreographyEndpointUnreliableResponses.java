...
@WebService
public class ChoreographyEndpointUnreliableResponses {
	...
	public ChoreographyEndpointUnreliableResponses() {
	...
	public static void main(String[] args) {
		...
		ChoreographyEndpointUnreliableResponses chor = new ChoreographyEndpointUnreliableResponses();
