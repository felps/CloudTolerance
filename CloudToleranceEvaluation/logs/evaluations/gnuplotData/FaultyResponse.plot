...
set x2range [ 1.00000 : 11.0000 ] noreverse nowriteback
set ylabel "Observed errors" 
set ylabel  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set y2label "" 
set y2label  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set yrange [ -0.0000 : 115.000 ] noreverse nowriteback
...
COL = 4
POINT = 100
set xtics ('100' 0,'99' 1,'98' 3,'97' 4,'96' 5,'95' 5,'94' 6,'93' 7,'92' 8,'91' 9);
#plot 'observedErrors.data' using 1:5 title 'Without Fault-Tolerance', 'observedErrors.data' using 4 title 'With Fault-Tolerance'
plot for [COL=4:5]  'observedErrors.data' using COL title columnheader(COL) \
#    EOF
