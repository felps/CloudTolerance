...
unset style line
unset style arrow
set style histogram errorbars gap 2 lw 1title  offset character 0, 0, 0
unset logscale
set offsets 0, 0, 0, 0
set pointsize 1
...
set title "" 
set title  offset character 0, 0, 0 font "Helvetica, 16" norotateset timestamp bottom 
set timestamp "" 
...
GNUTERM = "wxt"
plot 'teste.data' u 2:3:xtic(1) t columnheader(2), "" u 4:5:xtic(1) t columnheader(4)
#    EOF
