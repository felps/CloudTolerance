...
set title "Observed Composition Faults - Faulty Response from Web Services" 
...
set yrange [ -12.0000 : 115.000 ] noreverse nowriteback
...
plot for [COL=4:5]  'observedErrors-Time.data' using COL title columnheader(COL) \
#    EOF
