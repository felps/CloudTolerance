...
set output 'observedErrors-Time.eps'
...
unset style line
unset style arrow
set style histogram errorbars gap 2 lw 1 title  offset character 0, 0, 0
unset logscale
set offsets 0, 0, 0, 0
set pointsize 1
...
set title "Impact on Response Time due to Active FTT Usage" 
...
set ylabel "Avg. Response Time (in ms)" 
...
GNUTERM = "wxt"
plot 'observedErrors-Time.data' u 2:3:xtic(1) t columnheader(2), "" u 4:5:xtic(1) t columnheader(4), "" u 6:7:xtic(1) t columnheader(6), "" u 8:9:xtic(1) t columnheader(8)
#    EOF
